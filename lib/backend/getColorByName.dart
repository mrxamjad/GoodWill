...
Color getColorByName(String name) {
  ...
  if (name == "inprocess" || name == "in_process" || name == "inProcess") {
    return Colors.green;
  }
  if (name == "--:--" || name == "----") return Colors.amber;
  ...
  if (name == "Success" || name == "success") return Colors.green;
  if (name == "Pending" || name == "pending") return Colors.amber;
