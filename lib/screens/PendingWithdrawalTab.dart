        ...
        children: [
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: FutureBuilder(
                  future: FirebaseService.userRef.doc(DataClass.userKey).collection(FirebaseKey.withdrawDetails).where(FirebaseKey.withdrawStatus, isEqualTo: "pending").get(),
                        ...
                        return Padding(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              String date=DateFormat.MMMMd().format(DateTime.parse(dataList[index][FirebaseKey.withdrawRequestTime]));
                              String time=DateFormat.jm().format(DateTime.parse(dataList[index][FirebaseKey.withdrawRequestTime]));
                              ...
                              return paymentTransferCard(
                                ...
                                paymentStatus: dataList[index][FirebaseKey.withdrawStatus],
                                amount: dataList[index][FirebaseKey.withdrawAmount],
